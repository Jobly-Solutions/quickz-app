import { ICONO_AVANZAR, ICONO_VOLVER } from '@/assets/iconos';
                        ...
                        <View style={estilos.contenedorPantalla}>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity style={estilos.botonBlanco} onPress={() => { navigation.navigate('SoporteGeneral') }}>
                                        <View style={estilos.contenedorVertical}>
                                            <Text style={estilos.textoCentro}>{'Inconveniente con mi pedido'}</Text>
                                        </View>
                                        <Image style={estilos.iconoBotonPeque} source={ICONO_AVANZAR} />
                                    </TouchableOpacity>
                                    <TouchableOpacity style={estilos.botonBlanco} onPress={() => { navigation.navigate('SoporteGeneral') }}>
                                        <View style={estilos.contenedorVertical}>
                                            <Text style={estilos.textoCentro}>{'Inconveniente con la tienda'}</Text>
                                        </View>
                                        <Image style={estilos.iconoBotonPeque} source={ICONO_AVANZAR} />
                                    </TouchableOpacity>
                                    ...
                                    <TouchableOpacity style={estilos.botonBlanco} onPress={() => { navigation.navigate('SoporteGeneral') }}>
                                        <View style={estilos.contenedorVertical}>
                                            <Text style={estilos.textoCentro}>{'Inconveniente con mi cupón'}</Text>
                                        </View>
                                        <Image style={estilos.iconoBotonPeque} source={ICONO_AVANZAR} />
                                    </TouchableOpacity>
                                    ...
                                    <TouchableOpacity style={estilos.botonBlanco} onPress={() => { navigation.navigate('SoporteGeneral') }}>
                                        <View style={estilos.contenedorVertical}>
                                            <Text style={estilos.textoCentro}>{'Me arrepetí de una compra'}</Text>
                                        </View>
                                        <Image style={estilos.iconoBotonPeque} source={ICONO_AVANZAR} />
                                    </TouchableOpacity>
                                    ...
                                    <TouchableOpacity style={estilos.botonBlanco} onPress={() => { navigation.navigate('SoporteGeneral') }}>
                                        <View style={estilos.contenedorVertical}>
                                            <Text style={estilos.textoCentro}>{'Otras consultas'}</Text>
                                        </View>
                                        <Image style={estilos.iconoBotonPeque} source={ICONO_AVANZAR} />
                                    </TouchableOpacity>
